...
visualiser.clockSource.attach(audioPlayer);
visualiser.clockSource.realtime = true;
(async function () {
	if (location.search.indexOf("minimal") > -1) {
		self.scroll(0, dispCanv.offsetTop - 4);
	} else {
...
let renderThread = setInterval(function () {
	if (/*!audioPlayer.paused*/true) {
		...
		if (currentAnimation && !visualiser.demoInfo) {
			visualiser.demoInfo = currentAnimation;
		};
...
};
{
	// Ninety Hipty
	let perf = new TimedEvents();
	perf.push(new PointEvent(2.9, generateSwitch(14, 0, 0)));
	perf.push(new PointEvent(3.85, generateSwitch(3)));
	perf.push(new PointEvent(19.15, generateSwitch(2)));
	perf.push(new PointEvent(21.1, generateSwitch(9)));
	perf.push(new PointEvent(23.05, generateSwitch(5)));
	perf.push(new PointEvent(26.85, generateSwitch(3)));
	perf.push(new PointEvent(28.75, generateSwitch(8)));
	perf.push(new PointEvent(30.75, generateSwitch(4)));
	perf.push(new PointEvent(34.10, generateSwitch(14)));
	perf.push(new PointEvent(35.75, generateSwitch(4)));
	perf.push(new PointEvent(37.95, generateSwitch(3)));
	perf.push(new PointEvent(41.75, generateSwitch(8)));
	perf.push(new PointEvent(45.6, generateSwitch(1)));
	perf.push(new PointEvent(49.75, generateSwitch(6)));
	perf.push(new PointEvent(50.45, generateSwitch(7)));
	perf.push(new PointEvent(51.25, generateSwitch(3)));
	perf.push(new PointEvent(53.6, generateSwitch(6)));
	perf.push(new PointEvent(57.05, generateSwitch(7)));
	perf.push(new PointEvent(59.5, generateSwitch(3)));
	perf.push(new PointEvent(65.05, generateSwitch(6)));
	perf.push(new PointEvent(65.75, generateSwitch(7)));
	perf.push(new PointEvent(66.75, generateSwitch(3)));
	perf.push(new PointEvent(70.05, generateSwitch(14)));
	perf.push(new PointEvent(70.5, generateSwitch(3)));
	perf.push(new PointEvent(74.55, generateSwitch(10)));
	perf.push(new PointEvent(75.45, generateSwitch(11)));
	perf.push(new PointEvent(76.35, generateSwitch(13)));
	perf.push(new PointEvent(78.15, generateSwitch(15)));
	perf.push(new PointEvent(85.4, generateSwitch(13)));
	perf.push(new PointEvent(86.4, generateSwitch(12)));
	perf.push(new PointEvent(87.4, generateSwitch(11)));
	perf.push(new PointEvent(88.4, generateSwitch(10)));
	perf.push(new PointEvent(89.4, generateSwitch(8)));
	perf.push(new PointEvent(90.4, generateSwitch(5)));
	perf.push(new PointEvent(91.4, generateSwitch(4)));
	perf.push(new PointEvent(92.4, generateSwitch(3)));
	perf.push(new PointEvent(93.4, generateSwitch(2)));
	perf.push(new PointEvent(94.4, generateSwitch(0)));
	perf.fresh();
