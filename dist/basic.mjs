...
^,
_,`.split(`
`).forEach(r=>{let n=r.split(",");z[n[0]]=n[1]});var O=function(r,n,o){let a=[],e=o==!1?n.readIntVLV():o;r==0||r==127;for(let t=0;t<e;t++){let c=n.readInt(1);if(a.push(c),c!=247){if(c!=240){if(c>127)return console.debug(`Early termination: ${a}`),a.pop(),n.backOne(),n.backOne(),new Uint8Array(a)}}}return new Uint8Array(a)};var q=["?","gm","gs","xg","g2","mt32","ns5r","ag10","x5d","05rw","k11","sg","krs","s90es"];var k=[20,21,22,23,24,25,26,28,29,30,31,36,37,64,65],v=[0,1,2,4,5,6,7,8,10,11,32,38,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,84,91,92,93,94,95,98,99,100,101,128,12,13,16,17,18,19];var Q={};q.forEach((r,n)=>{Q[r]=n});var w={length:v.length};v.forEach((r,n)=>{w[r]=n});var D={length:k.length};k.forEach((r,n)=>{D[r]=n});var Ae={ch:128,cc:v.length,nn:128,pl:512,tr:256,cmt:14,rpn:6,ace:8,drm:8,dpn:k.length,dnc:128,efx:7};var C=V(I(),1);var A=class{#e=!1;constructor(r,n,o,a){this.#e=r,this.start=n,this.end=o,this.data=a}get duration(){return this.ranged?this.end-this.start:0}get ranged(){return this.#e}},x=class extends A{constructor(r,n,o){super(!0,r,n,o)}},U=class extends A{constructor(r,n){super(!1,r,r,n)}},T=class extends Array{#e=-1;constructor(){super(...arguments)}resetIndex(r){this.#e=-1}fresh(){this.sort(function(r,n){return r.start==n.start?0:(+(r.start>n.start)<<1)-1}),this.forEach(function(r,n){r.index=n})}step(r,n=!1){let o=[];if(n)for(let a=0;a<this.length&&!(this[a].start>r);a++){if(this[a].end<r)continue;o.push(this[a])}else{let a=this.getRange(this.#e==-1?0:r-1,r),e=this;a.forEach(function(t){t.index>e.#e&&(o.push(t),e.#e=t.index)})}return o}getRange(r,n){r>n&&([r,n]=[n,r]);let o=[],a=-1,e=Math.ceil(Math.sqrt(this.length)),t=!0;for(let c=0;c<this.length;c+=e)this[c+e]?a<0&&this[c+e].start>=r&&(a=c):a=a<0?c:a;for(;t;)this[a]?.end<n?this[a].start>=r&&o.push(this[a]):t=!1,a++;return o}};var j=0xffffffffffff,P=function(r){let n=new T,o=this,a=r.timeDivision,e=120,t=new T,c=0,d=0;t.push(new x(0,j,[120,0])),r.track.forEach(function(i){c=0,i.event.forEach(function(s){c+=s.deltaTime,s.type==255&&s?.metaType==81&&(e=6e7/s.data,t[t.length-1]&&t.push(new x(c,0xffffffffffff,[e,0])))})}),t.fresh(),t.forEach(function(i,s,l){s>0&&(l[s-1].end=i.start)});let $=120;t.forEach(function(i,s,l){s>0&&(i.end==i.start?l.splice(l.indexOf(i),1):$==i.data[0]&&(l[s-1].end=i.end,l.splice(l.indexOf(i),1)),$=i.data[0])});let u=0,p=120;return t.forEach(function(i){let s=i.start,l=s/p/a*60+u;p=i.data[0],u=l-s/p/a*60,i.data[1]=u}),console.debug("All tempo changes: ",t),e=120,c=0,d=0,r.track.forEach(function(i,s){c=0,d=0;let l=s+1;i.event.forEach(function(f,b){c+=f.deltaTime;let h=t.step(c,!0)[0];h&&(e=h.data[0],d=h.data[1]);let g={type:f.type,data:f.data,track:l,part:0};f.type>14?g.meta=f.metaType:g.part=f.channel,n.push(new U(c/e/a*60+d,g))})}),n.fresh(),self.midiEvents=n,console.debug(`Parsed a type ${r.formatType} MIDI sequence.`),n};C.default.customInterpreter=O;var qe=class extends E{device;#e;#i="";#s=[];#n=new Uint8ClampedArray(128);#h=new Uint8ClampedArray(128);#a=.5;#l=120;#t=4;#o=4;#r=0;#c=0;smoothingAtk=0;smoothingDcy=0;reset(){this.dispatchEvent("reset"),this.#e?.resetIndex(),this.device.init(),this.#i="",this.#a=.5,this.#l=120,this.#t=4,this.#o=4,this.#r=0,this.#c=0}async loadFile(r){this.#e=P(C.default.parse(new Uint8Array(await r.arrayBuffer())))}switchMode(r,n=!1){this.device.switchMode(r,n)}getMode(){return this.device.getMode()}getVoice(){return this.device.getVoice(...arguments)}getChVoice(r){return this.device.getChVoice(r)}get noteProgress(){return this.#c/this.#a}get noteOverall(){return this.noteProgress-this.#r}get noteBar(){return Math.floor(this.noteOverall/this.#t)}get noteBeat(){let r=this.noteOverall%this.#t;return r<0&&(r+=this.#t),r}getTimeSig(){return[this.#t,this.#o]}getTempo(){return this.#l}sendCmd(r){this.device.runJson(r)}render(r){r>this.#c&&(this.#c=r);let n=this.#e?.step(r)||[],o=0,a=new Set,e=this,t=[];this.device.getStrength().forEach((b,h)=>{this.#h[h]=b}),e.device.newStrength(),n.forEach(function(b){let h=b.data;h.type==9&&(h.data[1]>0?a.add(h.part*128+h.data[0]):a.has(h.part*128+h.data[0])&&o++),b.data.type==8&&a.has(h.part*128+h.data[0])&&o++;let g=e.device.runJson(h);switch(g?.reply){case"meta":{t.push(g);break}}g?.reply&&delete g.reply}),t?.length>0&&this.dispatchEvent("meta",t);let c=this.device.getActive(),d=[],$=e.device.getPitch(),u=e.device.getCcAll(),p=e.device.getProgram(),i=e.device.getChType(),s=this.device.getStrength();s.forEach(function(b,h,g){g[h]=Math.max(e.#h[h],b);let y=g[h]-e.#n[h],M=w.length*h;if(y>=0){let m=4*.25**(u[M+w[73]]/64);e.#n[h]+=Math.ceil(y-y*e.smoothingAtk**m)}else{let m=4*.25**(u[M+w[72]]/64);e.#n[h]+=Math.floor(y-y*e.smoothingDcy**m)}});let l=0;return c.forEach(function(b,h){b&&(d[h]=e.device.getVel(h),l+=d[h].size)}),{extraPoly:o,curPoly:l,chInUse:c,chKeyPr:d,chPitch:$,chProgr:p,chContr:u,chType:i,eventCount:n.length,title:this.#i,bitmap:this.device.getBitmap(),letter:this.device.getLetter(),texts:this.device.getTexts(),master:this.device.getMaster(),mode:this.device.getMode(),strength:this.#n.slice(),velo:s,rpn:this.device.getRpn(),tSig:this.getTimeSig(),tempo:this.getTempo(),noteBar:this.noteBar,noteBeat:this.noteBeat,ace:this.device.getAce()}}constructor(r,n=.5,o=.5){super();let a=this;this.smoothingAtk=n,this.smoothingDcy=o,this.device=r,this.addEventListener("meta",function(e){e?.data?.forEach(function(t){(a.#s[t.meta]||console.debug).call(a,t.meta,t.data)})}),this.device.addEventListener("mode",function(e){a.dispatchEvent("mode",e.data)}),this.device.addEventListener("channelactive",function(e){a.dispatchEvent("channelactive",e.data)}),this.device.addEventListener("channelmin",function(e){a.dispatchEvent("channelmin",e.data)}),this.device.addEventListener("channelmax",function(e){a.dispatchEvent("channelmax",e.data)}),this.device.addEventListener("channelreset",function(e){a.dispatchEvent("channelreset")}),this.device.addEventListener("screen",function(e){a.dispatchEvent("screen",e.data)}),this.#s[3]=function(e,t){a.#i?.length<1&&(a.#i=t)},this.#s[81]=function(e,t){let c=a.noteProgress,d=a.#a||.5;a.#l=6e7/t,a.#a=t/1e6,a.#r+=c*(d/a.#a)-c},this.#s[88]=function(e,t){let c=a.noteProgress,d=a.noteOverall,$=a.noteBar,u=a.noteBeat,p=a.#t,i=a.#o;a.#t=t[0],a.#o=1<<t[1];let s=24*(32/t[3])/t[2];if(p!=a.#t){let l=$;a.#r-=l*(a.#t-p),u+1>=p&&(p<a.#t?a.#r-=Math.ceil(a.#t-u-1):a.#r+=a.#t)}}}};export{qe as RootDisplay,w as ccToPos,D as dnToPos};
