...
^,
_,`.split(`
`).forEach(r=>{let n=r.split(",");V[n[0]]=n[1]});var R=function(r,n,o){let a=[],e=o==!1?n.readIntVLV():o;r==0||r==127;for(let t=0;t<e;t++){let c=n.readInt(1);if(a.push(c),c!=247){if(c!=240){if(c>127)return console.debug(`Early termination: ${a}`),a.pop(),n.backOne(),n.backOne(),new Uint8Array(a)}}}return new Uint8Array(a)};var X=["?","gm","gs","xg","g2","mt32","ns5r","ag10","x5d","05rw","krs","k11","sg"];var w=[0,1,2,4,5,6,7,8,10,11,32,38,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,84,91,92,93,94,95,98,99,100,101,12,13,16,17,18,19];var z={};X.forEach((r,n)=>{z[r]=n});var m={length:w.length};w.forEach((r,n)=>{m[r]=n});var Te={ch:128,cc:w.length,nn:128,pl:512,tr:256,cmt:14,rpn:6};var M=H(C(),1);var T=class{#e=!1;constructor(r,n,o,a){this.#e=r,this.start=n,this.end=o,this.data=a}get duration(){return this.ranged?this.end-this.start:0}get ranged(){return this.#e}},x=class extends T{constructor(r,n,o){super(!0,r,n,o)}},P=class extends T{constructor(r,n){super(!1,r,r,n)}},E=class extends Array{#e=-1;constructor(){super(...arguments)}resetIndex(r){this.#e=-1}fresh(){this.sort(function(r,n){return r.start==n.start?0:(+(r.start>n.start)<<1)-1}),this.forEach(function(r,n){r.index=n})}step(r,n=!1){let o=[];if(n)for(let a=0;a<this.length&&!(this[a].start>r);a++){if(this[a].end<r)continue;o.push(this[a])}else{let a=this.getRange(this.#e==-1?0:r-1,r),e=this;a.forEach(function(t){t.index>e.#e&&(o.push(t),e.#e=t.index)})}return o}getRange(r,n){r>n&&([r,n]=[n,r]);let o=[],a=-1,e=Math.ceil(Math.sqrt(this.length)),t=!0;for(let c=0;c<this.length;c+=e)this[c+e]?a<0&&this[c+e].start>=r&&(a=c):a=a<0?c:a;for(;t;)this[a]?.end<n?this[a].start>=r&&o.push(this[a]):t=!1,a++;return o}};var K=0xffffffffffff,I=function(r){let n=new E,o=this,a=r.timeDivision,e=120,t=new E,c=0,h=0;t.push(new x(0,K,[120,0])),r.track.forEach(function(i){c=0,i.event.forEach(function(s){c+=s.deltaTime,s.type==255&&s?.metaType==81&&(e=6e7/s.data,t[t.length-1]&&t.push(new x(c,0xffffffffffff,[e,0])))})}),t.fresh(),t.forEach(function(i,s,l){s>0&&(l[s-1].end=i.start)});let b=120;t.forEach(function(i,s,l){s>0&&(i.end==i.start?l.splice(l.indexOf(i),1):b==i.data[0]&&(l[s-1].end=i.end,l.splice(l.indexOf(i),1)),b=i.data[0])});let g=0,p=120;return t.forEach(function(i){let s=i.start,l=s/p/a*60+g;p=i.data[0],g=l-s/p/a*60,i.data[1]=g}),console.debug("All tempo changes: ",t),e=120,c=0,h=0,r.track.forEach(function(i,s){c=0,h=0;let l=s+1;i.event.forEach(function(d,f){c+=d.deltaTime;let u=t.step(c,!0)[0];u&&(e=u.data[0],h=u.data[1]);let $={type:d.type,data:d.data,track:l,part:0};d.type>14?$.meta=d.metaType:$.part=d.channel,n.push(new P(c/e/a*60+h,$))})}),n.fresh(),self.midiEvents=n,console.debug(`Parsed a type ${r.formatType} MIDI sequence.`),n};M.default.customInterpreter=R;var ze=class extends k{device;#e;#i="";#s=[];#n=new Uint8ClampedArray(64);#a=.5;#l=120;#t=4;#o=4;#r=0;#c=0;smoothingAtk=0;smoothingDcy=0;reset(){this.dispatchEvent("reset"),this.#e?.resetIndex(),this.device.init(),this.#i="",this.#a=.5,this.#l=120,this.#t=4,this.#o=4,this.#r=0,this.#c=0}async loadFile(r){this.#e=I(M.default.parse(new Uint8Array(await r.arrayBuffer())))}switchMode(r,n=!1){this.device.switchMode(r,n)}getMode(){return this.device.getMode()}getVoice(){return this.device.getVoice(...arguments)}getChVoice(r){return this.device.getChVoice(r)}get noteProgress(){return this.#c/this.#a}get noteOverall(){return this.noteProgress-this.#r}get noteBar(){return Math.floor(this.noteOverall/this.#t)}get noteBeat(){let r=this.noteOverall%this.#t;return r<0&&(r+=this.#t),r}getTimeSig(){return[this.#t,this.#o]}getTempo(){return this.#l}sendCmd(r){this.device.runJson(r)}render(r){r>this.#c&&(this.#c=r);let n=this.#e?.step(r)||[],o=0,a=new Set,e=this,t=[];e.device.newStrength(),n.forEach(function(d){let f=d.data;f.type==9&&(f.data[1]>0?a.add(f.part*128+f.data[0]):a.has(f.part*128+f.data[0])&&o++),d.data.type==8&&a.has(f.part*128+f.data[0])&&o++;let u=e.device.runJson(f);switch(u?.reply){case"meta":{t.push(u);break}}u?.reply&&delete u.reply}),t?.length>0&&this.dispatchEvent("meta",t);let c=this.device.getActive(),h=[],b=e.device.getPitch(),g=e.device.getCcAll(),p=e.device.getProgram(),i=this.device.getStrength();i.forEach(function(d,f){let u=d-e.#n[f],$=m.length*f;if(u>=0){let y=4*.25**(g[$+m[73]]/64);e.#n[f]+=Math.ceil(u-u*e.smoothingAtk**y)}else{let y=4*.25**(g[$+m[72]]/64);e.#n[f]+=Math.ceil(u-u*e.smoothingDcy**y)}});let s=0;return c.forEach(function(d,f){d&&(h[f]=e.device.getVel(f),s+=h[f].size)}),{extraPoly:o,curPoly:s,chInUse:c,chKeyPr:h,chPitch:b,chProgr:p,chContr:g,eventCount:n.length,title:this.#i,bitmap:this.device.getBitmap(),letter:this.device.getLetter(),texts:this.device.getTexts(),master:this.device.getMaster(),mode:this.device.getMode(),strength:this.#n.slice(),velo:i,rpn:this.device.getRpn(),tSig:this.getTimeSig(),tempo:this.getTempo(),noteBar:this.noteBar,noteBeat:this.noteBeat}}constructor(r,n=.5,o=.5){super();let a=this;this.smoothingAtk=n,this.smoothingDcy=o,this.device=r,this.addEventListener("meta",function(e){e?.data?.forEach(function(t){(a.#s[t.meta]||console.debug).call(a,t.meta,t.data)})}),this.device.addEventListener("mode",function(e){a.dispatchEvent("mode",e.data)}),this.device.addEventListener("channelactive",function(e){a.dispatchEvent("channelactive",e.data)}),this.device.addEventListener("channelmin",function(e){a.dispatchEvent("channelmin",e.data)}),this.device.addEventListener("channelmax",function(e){a.dispatchEvent("channelmax",e.data)}),this.device.addEventListener("channelreset",function(e){a.dispatchEvent("channelreset")}),this.device.addEventListener("screen",function(e){a.dispatchEvent("screen",e.data)}),this.#s[3]=function(e,t){a.#i?.length<1&&(a.#i=t)},this.#s[81]=function(e,t){let c=a.noteProgress,h=a.#a||.5;a.#l=6e7/t,a.#a=t/1e6,a.#r+=c*(h/a.#a)-c},this.#s[88]=function(e,t){let c=a.noteProgress,h=a.noteOverall,b=a.noteBar,g=a.noteBeat,p=a.#t,i=a.#o;a.#t=t[0],a.#o=1<<t[1];let s=24*(32/t[3])/t[2];if(p!=a.#t){let l=b;a.#r-=l*(a.#t-p),g+1>=p&&(p<a.#t?a.#r-=Math.ceil(a.#t-g-1):a.#r+=a.#t)}}}};export{ze as RootDisplay,m as ccToPos};
