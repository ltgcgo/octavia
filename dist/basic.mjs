...
^,
_,`.split(`
`).forEach(a=>{let s=a.split(",");K[s[0]]=s[1]});var O=function(a,s,o){let t=[],e=o==!1?s.readIntVLV():o;a==0||a==127;for(let r=0;r<e;r++){let c=s.readInt(1);if(t.push(c),c!=247){if(c!=240){if(c>127)return console.debug(`Early termination: ${t}`),t.pop(),s.backOne(),s.backOne(),new Uint8Array(t)}}}return new Uint8Array(t)};var z=["?","gm","gs","xg","g2","mt32","ns5r","ag10","x5d","05rw","krs","k11","sg"];var k=[20,21,22,23,24,25,26,28,29,30,31,36,37,64,65],v=[0,1,2,4,5,6,7,8,10,11,32,38,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,84,91,92,93,94,95,98,99,100,101,128,12,13,16,17,18,19];var q={};z.forEach((a,s)=>{q[a]=s});var m={length:v.length};v.forEach((a,s)=>{m[a]=s});var Q={length:k.length};k.forEach((a,s)=>{Q[a]=s});var Ie={ch:128,cc:v.length,nn:128,pl:512,tr:256,cmt:14,rpn:6,ace:8,drm:8,dpn:k.length,dnc:128,efx:7};var C=F(A(),1);var D=class{#e=!1;constructor(a,s,o,t){this.#e=a,this.start=s,this.end=o,this.data=t}get duration(){return this.ranged?this.end-this.start:0}get ranged(){return this.#e}},x=class extends D{constructor(a,s,o){super(!0,a,s,o)}},I=class extends D{constructor(a,s){super(!1,a,a,s)}},T=class extends Array{#e=-1;constructor(){super(...arguments)}resetIndex(a){this.#e=-1}fresh(){this.sort(function(a,s){return a.start==s.start?0:(+(a.start>s.start)<<1)-1}),this.forEach(function(a,s){a.index=s})}step(a,s=!1){let o=[];if(s)for(let t=0;t<this.length&&!(this[t].start>a);t++){if(this[t].end<a)continue;o.push(this[t])}else{let t=this.getRange(this.#e==-1?0:a-1,a),e=this;t.forEach(function(r){r.index>e.#e&&(o.push(r),e.#e=r.index)})}return o}getRange(a,s){a>s&&([a,s]=[s,a]);let o=[],t=-1,e=Math.ceil(Math.sqrt(this.length)),r=!0;for(let c=0;c<this.length;c+=e)this[c+e]?t<0&&this[c+e].start>=a&&(t=c):t=t<0?c:t;for(;r;)this[t]?.end<s?this[t].start>=a&&o.push(this[t]):r=!1,t++;return o}};var j=0xffffffffffff;{let a=function(s,o){let t=new FileReader;return new Promise((e,r)=>{switch(t.addEventListener("abort",()=>{r(new Error("Blob read aborted"))}),t.addEventListener("error",c=>{r(t.error||c.data||new Error("Blob read error"))}),t.addEventListener("load",()=>{e(t.result)}),o.toLowerCase()){case"arraybuffer":case"buffer":{t.readAsArrayBuffer(s);break}case"string":case"text":{t.readAsText(s);break}default:r(new Error(`Unknown target ${o}`))}})};Blob.prototype.arrayBuffer=function(){return a(this,"arrayBuffer")}}var U=function(a){let s=new T,o=this,t=a.timeDivision,e=120,r=new T,c=0,d=0;r.push(new x(0,j,[120,0])),a.track.forEach(function(i){c=0,i.event.forEach(function(n){c+=n.deltaTime,n.type==255&&n?.metaType==81&&(e=6e7/n.data,r[r.length-1]&&r.push(new x(c,0xffffffffffff,[e,0])))})}),r.fresh(),r.forEach(function(i,n,l){n>0&&(l[n-1].end=i.start)});let $=120;r.forEach(function(i,n,l){n>0&&(i.end==i.start?l.splice(l.indexOf(i),1):$==i.data[0]&&(l[n-1].end=i.end,l.splice(l.indexOf(i),1)),$=i.data[0])});let u=0,p=120;return r.forEach(function(i){let n=i.start,l=n/p/t*60+u;p=i.data[0],u=l-n/p/t*60,i.data[1]=u}),console.debug("All tempo changes: ",r),e=120,c=0,d=0,a.track.forEach(function(i,n){c=0,d=0;let l=n+1;i.event.forEach(function(f,b){c+=f.deltaTime;let h=r.step(c,!0)[0];h&&(e=h.data[0],d=h.data[1]);let g={type:f.type,data:f.data,track:l,part:0};f.type>14?g.meta=f.metaType:g.part=f.channel,s.push(new I(c/e/t*60+d,g))})}),s.fresh(),self.midiEvents=s,console.debug(`Parsed a type ${a.formatType} MIDI sequence.`),s};C.default.customInterpreter=O;var Qe=class extends E{device;#e;#i="";#s=[];#n=new Uint8ClampedArray(128);#h=new Uint8ClampedArray(128);#a=.5;#l=120;#t=4;#o=4;#r=0;#c=0;smoothingAtk=0;smoothingDcy=0;reset(){this.dispatchEvent("reset"),this.#e?.resetIndex(),this.device.init(),this.#i="",this.#a=.5,this.#l=120,this.#t=4,this.#o=4,this.#r=0,this.#c=0}async loadFile(a){this.#e=U(C.default.parse(new Uint8Array(await a.arrayBuffer())))}switchMode(a,s=!1){this.device.switchMode(a,s)}getMode(){return this.device.getMode()}getVoice(){return this.device.getVoice(...arguments)}getChVoice(a){return this.device.getChVoice(a)}get noteProgress(){return this.#c/this.#a}get noteOverall(){return this.noteProgress-this.#r}get noteBar(){return Math.floor(this.noteOverall/this.#t)}get noteBeat(){let a=this.noteOverall%this.#t;return a<0&&(a+=this.#t),a}getTimeSig(){return[this.#t,this.#o]}getTempo(){return this.#l}sendCmd(a){this.device.runJson(a)}render(a){a>this.#c&&(this.#c=a);let s=this.#e?.step(a)||[],o=0,t=new Set,e=this,r=[];this.device.getStrength().forEach((b,h)=>{this.#h[h]=b}),e.device.newStrength(),s.forEach(function(b){let h=b.data;h.type==9&&(h.data[1]>0?t.add(h.part*128+h.data[0]):t.has(h.part*128+h.data[0])&&o++),b.data.type==8&&t.has(h.part*128+h.data[0])&&o++;let g=e.device.runJson(h);switch(g?.reply){case"meta":{r.push(g);break}}g?.reply&&delete g.reply}),r?.length>0&&this.dispatchEvent("meta",r);let c=this.device.getActive(),d=[],$=e.device.getPitch(),u=e.device.getCcAll(),p=e.device.getProgram(),i=e.device.getChType(),n=this.device.getStrength();n.forEach(function(b,h,g){g[h]=Math.max(e.#h[h],b);let y=g[h]-e.#n[h],M=m.length*h;if(y>=0){let w=4*.25**(u[M+m[73]]/64);e.#n[h]+=Math.ceil(y-y*e.smoothingAtk**w)}else{let w=4*.25**(u[M+m[72]]/64);e.#n[h]+=Math.floor(y-y*e.smoothingDcy**w)}});let l=0;return c.forEach(function(b,h){b&&(d[h]=e.device.getVel(h),l+=d[h].size)}),{extraPoly:o,curPoly:l,chInUse:c,chKeyPr:d,chPitch:$,chProgr:p,chContr:u,chType:i,eventCount:s.length,title:this.#i,bitmap:this.device.getBitmap(),letter:this.device.getLetter(),texts:this.device.getTexts(),master:this.device.getMaster(),mode:this.device.getMode(),strength:this.#n.slice(),velo:n,rpn:this.device.getRpn(),tSig:this.getTimeSig(),tempo:this.getTempo(),noteBar:this.noteBar,noteBeat:this.noteBeat,ace:this.device.getAce()}}constructor(a,s=.5,o=.5){super();let t=this;this.smoothingAtk=s,this.smoothingDcy=o,this.device=a,this.addEventListener("meta",function(e){e?.data?.forEach(function(r){(t.#s[r.meta]||console.debug).call(t,r.meta,r.data)})}),this.device.addEventListener("mode",function(e){t.dispatchEvent("mode",e.data)}),this.device.addEventListener("channelactive",function(e){t.dispatchEvent("channelactive",e.data)}),this.device.addEventListener("channelmin",function(e){t.dispatchEvent("channelmin",e.data)}),this.device.addEventListener("channelmax",function(e){t.dispatchEvent("channelmax",e.data)}),this.device.addEventListener("channelreset",function(e){t.dispatchEvent("channelreset")}),this.device.addEventListener("screen",function(e){t.dispatchEvent("screen",e.data)}),this.#s[3]=function(e,r){t.#i?.length<1&&(t.#i=r)},this.#s[81]=function(e,r){let c=t.noteProgress,d=t.#a||.5;t.#l=6e7/r,t.#a=r/1e6,t.#r+=c*(d/t.#a)-c},this.#s[88]=function(e,r){let c=t.noteProgress,d=t.noteOverall,$=t.noteBar,u=t.noteBeat,p=t.#t,i=t.#o;t.#t=r[0],t.#o=1<<r[1];let n=24*(32/r[3])/r[2];if(p!=t.#t){let l=$;t.#r-=l*(t.#t-p),u+1>=p&&(p<t.#t?t.#r-=Math.ceil(t.#t-u-1):t.#r+=t.#t)}}}};export{Qe as RootDisplay,m as ccToPos};
